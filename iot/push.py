#!/usr/bin/python3
# this script is our main IoT push script
# it opens and reads the various data to be pushed
# we use dweet.io along with freeboard.io for storing and
# displaying of real-time iot sensory data.
import requests
